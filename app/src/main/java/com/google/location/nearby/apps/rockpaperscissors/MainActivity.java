...
public class MainActivity extends AppCompatActivity {
  ...
  private TextView connected_name_textview;
  ...
  private void setOpponentName(String opponentName) {
    connected_name_textview.setText(getString(R.string.opponent_name, opponentName));
  }
